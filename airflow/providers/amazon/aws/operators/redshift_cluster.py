...
class _BaseRedshiftOperator(Boto3Mixin[RedshiftHook], BaseOperator):
    """Base Amazon Redshift Operator."""

    aws_hook_class = RedshiftHook

    @property
    @deprecated(reason="use `hook` property instead.", category=AirflowProviderDeprecationWarning)
    def redshift_hook(self):
        return self.hook


class RedshiftCreateClusterOperator(_BaseRedshiftOperator):
    ...
    def execute(self, context: Context):
        ...
        if self.wait_for_completion:
            self.hook.get_waiter("cluster_available").wait(
...
class RedshiftCreateClusterSnapshotOperator(_BaseRedshiftOperator):
    """
    ...
    def execute(self, context: Context) -> Any:
        ...
        if self.wait_for_completion:
            self.hook.get_waiter("snapshot_available").wait(
                ClusterIdentifier=self.cluster_identifier,
                WaiterConfig={
                    "Delay": self.poll_interval,
                    "MaxAttempts": self.max_attempt,
...
class RedshiftDeleteClusterSnapshotOperator(_BaseRedshiftOperator):
    """
...
class RedshiftResumeClusterOperator(_BaseRedshiftOperator):
    """
...
class RedshiftPauseClusterOperator(_BaseRedshiftOperator):
    """
...
class RedshiftDeleteClusterOperator(_BaseRedshiftOperator):
    """
    ...
    def execute(self, context: Context):
        ...
        if self.deferrable:
            ...
            waiter = self.hook.get_waiter("cluster_deleted")
            waiter.wait(
                ClusterIdentifier=self.cluster_identifier,
