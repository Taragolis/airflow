...
class _BaseStepFunctionsOperator(Boto3Mixin[StepFunctionHook], BaseOperator):
    """Base AWS Step Functions Operator."""

    aws_hook_class = StepFunctionHook


class StepFunctionStartExecutionOperator(_BaseStepFunctionsOperator):
    """
    ...
    def execute(self, context: Context):
        execution_arn = self.hook.start_execution(self.state_machine_arn, self.name, self.input)
...
class StepFunctionGetExecutionOutputOperator(_BaseStepFunctionsOperator):
    """
