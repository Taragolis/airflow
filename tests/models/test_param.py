...
class TestParam:
    ...
    @pytest.mark.parametrize(
        "dt",
        [
            pytest.param("2022-01-02T03:04:05.678901Z", id="microseconds-zero-timezone"),
            pytest.param("2022-01-02T03:04:05.678Z", id="milliseconds-zero-timezone"),
            pytest.param("2022-01-02T03:04:05+00:00", id="seconds-00-00-timezone"),
            pytest.param("2022-01-02T03:04:05+04:00", id="milliseconds-custom-timezone"),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "dt, expected",
        [
            pytest.param("2022-01-02 03:04:05.678901Z", "2022-01-02T03:04:05.678901+00:00", id="space-sep"),
            pytest.param("2022-01-02T03:04:05.678901", "2022-01-02T03:04:05.678901+00:00", id="tz-naive"),
            pytest.param("2022-01-02T03Z", "2022-01-02T03:00:00+00:00", id="datetime-with-day-only"),
            pytest.param("20161001T143028+0530", "2016-10-01T14:30:28+05:30", id="not-formatted-date-time"),
        ],
    )
    def test_string_iso8601_datetime_invalid_rfc3339_format(self, dt, expected):
        """Test valid iso8601 datetime but not valid rfc3339 datetime conversion."""
        with pytest.warns(RemovedInAirflow3Warning):
            assert Param(dt, type="string", format="date-time").resolve() == expected

    @pytest.mark.parametrize(
        "dt", [pytest.param("2022-01-02", id="date"), pytest.param("03:04:05", id="time")]
    )
